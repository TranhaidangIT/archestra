 ...
 * Get A2A AgentCard for an internal agent (must be agentType='agent')
 */
export const getV2A2aByAgentIdWellKnownAgentJson = <ThrowOnError extends boolean = false>(options: Options<GetV2A2aByAgentIdWellKnownAgentJsonData, ThrowOnError>) => (options.client ?? client).get<GetV2A2aByAgentIdWellKnownAgentJsonResponses, unknown, ThrowOnError>({ url: '/v2/a2a/{agentId}/.well-known/agent.json', ...options });
